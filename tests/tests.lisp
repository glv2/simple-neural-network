...
(test nn-xor
  (let ((inputs '(#(0.0d0 0.0d0)
    ...
    (is-true (< (aref (predict nn #(0.0d0 0.0d0)) 0) 0.2))
    (is-true (> (aref (predict nn #(1.0d0 0.0d0)) 0) 0.8))
    (is-true (> (aref (predict nn #(0.0d0 1.0d0)) 0) 0.8))
    (is-true (< (aref (predict nn #(1.0d0 1.0d0)) 0) 0.2))))
